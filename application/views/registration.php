...
<head>
    ...
    <link rel='stylesheet' href='<?php echo base_url()?><?php echo base_url()?>css/component.css' type='text/css' media='all'>
...
<body data-rsssl="1" class="home  hotelmaster-button-classic-style  header-style-1  hotelmaster-classic-style  hotelmaster-single-classic-style">
                    ...
                    <div class="gdlr-navigation-wrapper">
                        <nav class="gdlr-navigation" id="gdlr-main-navigation" role="navigation">
                            <ul id="menu-main-menu-1" class="sf-menu gdlr-main-menu">
                                <li class="menu-item  gdlr-normal-menu"><a href="<?php echo base_url()?>">Home</a></li>
                        ...
                        <div class="with-sidebar-left twelve columns">
                            <div class="with-sidebar-content six columns" style="width: 62%;">
                                <div class="gdlr-item gdlr-item-start-content" id="gdlr-single-booking-content" data-ajax="https://demo.goodlayers.com/hotelmaster/wp-admin/admin-ajax.php">
									<center>
                                        <form class="gdlr-reservation-bar" data-action="gdlr_hotel_booking" action="<?php echo base_url()?>home/registration" method="post">
                                        <div class="gdlr-reservation-bar-title">Your Registration</div>
                                        ...
                                        <div class="gdlr-reservation-bar-date-form">
                                            <div class="gdlr-reservation-field gdlr-resv-datepicker"><span class="gdlr-reservation-field-title">Name</span>
                                                <div class="">
                                                    <input type="text" id="" class="" name="cname">
                                                    <input type="hidden" class="gdlr-datepicker-alt" name="gdlr-check-in" autocomplete="off" value="2018-05-03">
                                                </div>
                                            </div>
                                            <div class="gdlr-reservation-field gdlr-resv-combobox "><span class="gdlr-reservation-field-title">Address</span>
                                                <div class="">
                                                   <input type="text" id="" class="" name="address">
                                                </div>
                                            </div>
                                            <div class="clear"></div>
                                            
                                            <div class="gdlr-reservation-field gdlr-resv-combobox gdlr-reservation-bar-room-number"><span class="gdlr-reservation-field-title">contact Number</span>
                                                <div class="">
                                                     <input type="text" id="" class="" name="nub">
                                                </div>
                                            </div>
											 <div class="clear"></div>
                                            <div class="gdlr-reservation-field gdlr-resv-combobox gdlr-reservation-bar-room-number"><span class="gdlr-reservation-field-title">Email-Id</span>
                                                <div class="">
                                                    <input type="email" id="" class="" name="email">
                                                </div>
                                            </div>
											 <div class="clear"></div>
                                            <div class="gdlr-reservation-field gdlr-resv-combobox gdlr-reservation-bar-room-number"><span class="gdlr-reservation-field-title">Password</span>
                                                <div class="">
                                                     <input type="password" id="" class="" name="pass">
                                                </div>
                                            </div>
                                            <div class="clear"></div>
                                            ...
                                            <div class="clear"></div><input type="submit" class="gdlr-reservation-bar-button gdlr-button with-border" value="Register">
                                            <div class="clear"></div>
                                        </div>
    ...
    <script type='text/javascript' src='<?php echo base_url()?><?php echo base_url()?><?php echo base_url()?>js/jquery.js'></script>
    <script type='text/javascript' src='<?php echo base_url()?><?php echo base_url()?>js/jquery-migrate.min.js'></script>
    ...
    <script type='text/javascript' src='<?php echo base_url()?><?php echo base_url()?>js/modernizr.custom.js'></script>
    ...
    <script type='text/javascript' src='<?php echo base_url()?><?php echo base_url()?>js/jquery.transit.min.js'></script>
