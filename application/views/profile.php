    ...
    <div class="body-wrapper gdlr-boxed-style float-menu gdlr-icon-dark gdlr-header-solid" data-home="index-2.jsp">
                    ...
                    <div class="gdlr-navigation-wrapper">
                        <nav class="gdlr-navigation" id="gdlr-main-navigation" role="navigation">
                            <ul id="menu-main-menu-1" class="sf-menu gdlr-main-menu">
                                ...
                                {
                                ?>
                                    <li class="menu-itemmenu-item current-menu-item menu-item current-menu-item gdlr-normal-menu"><a href="<?php echo base_url()?>home/profile">Profile</a></li>
        ...
        <div class="gdlr-page-title-wrapper">
            ...
            <div class="gdlr-page-title-container container">
                <h1 class="gdlr-page-title">Profile</h1>
            </div>
        </div>
        <!-- is search -->
                        ...
                        <div class="with-sidebar-left twelve columns">
                            <div class="with-sidebar-content six columns" style="width: 60%;">
                                <div class="gdlr-item gdlr-item-start-content" id="gdlr-single-booking-content" data-ajax="https://demo.goodlayers.com/hotelmaster/wp-admin/admin-ajax.php">
									<center>
                                        <form class="gdlr-reservation-bar" data-action="gdlr_hotel_booking" action="<?php echo base_url()?>home/updateprofile" method="post">
                                        <div class="gdlr-reservation-bar-title">Profile</div>
                                        ...
                                        <div class="gdlr-reservation-bar-date-form">
                                            <div class="gdlr-reservation-field gdlr-resv-datepicker"><span class="gdlr-reservation-field-title">Name</span>
                                                <div class="">
                                                    <input type="text" id="" class="" name="uname" value="<?php echo $_SESSION["UserName"]?>">
                                                    
                                                </div>
                                            </div>
                                            <div class="gdlr-reservation-field gdlr-resv-combobox "><span class="gdlr-reservation-field-title">Address</span>
                                                <div class="">
                                                   <input type="text" id="" class="" name="address" value="<?php echo $_SESSION["Address"]?>">
                                                </div>
                                            </div>
                                            <div class="clear"></div>
                                            ...
                                            <div class="gdlr-reservation-field gdlr-resv-combobox gdlr-reservation-bar-room-number"><span class="gdlr-reservation-field-title">Contact Number</span>
                                                <div class="">
                                                     <input type="text" id="" class="" name="nub" value="<?php echo $_SESSION["Contact"]?>">
                                                </div>
                                            </div>
                                             <div class="clear"></div>
                                            <div class="gdlr-reservation-field gdlr-resv-combobox gdlr-reservation-bar-room-number"><span class="gdlr-reservation-field-title">Email-Id</span>
                                                <div class="">
                                                    <input type="text" id="" class="" name="email" readonly value="<?php echo $_SESSION["Email"]?>">
                                                </div>
                                            </div>
                                             <div class="clear"></div>
                                            <div class="gdlr-reservation-field gdlr-resv-combobox gdlr-reservation-bar-room-number"><span class="gdlr-reservation-field-title">Password</span>
                                                <div class="">
                                                     <input type="password" id="" class="" name="pass" value="<?php echo $_SESSION["Password"]?>">
                                                </div>
                                            </div>
                                            <div class="clear"></div>
                                            ...
                                            <div class="clear"></div><input type="submit" class="gdlr-reservation-bar-button gdlr-button with-border" value="Update">
                                            <div class="clear"></div>
                                        </div>
