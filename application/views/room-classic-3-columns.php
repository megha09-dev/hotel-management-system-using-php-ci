                    ...
                    <div class="gdlr-navigation-wrapper">
                        <nav class="gdlr-navigation" id="gdlr-main-navigation" role="navigation">
                            <ul id="menu-main-menu-1" class="sf-menu gdlr-main-menu">
                                ...
                                <li class="menu-item current-menu-item menu-item current-menu-item gdlr-normal-menu"><a href="<?php echo base_url()?>home/allroom" class="sf-with-ul-pre">Rooms</a>
                                        ...
                                        <div class="gdlr-item gdlr-room-item gdlr-classic-room">
                                            <div class="gdlr-ux gdlr-classic-room-ux">
                                                <div class="gdlr-room-thumbnail">
                                                    <a href="#"><img src="<?php echo base_url().$value['Image']?>" alt="" width="700" height="400"></a>
                                                </div>
                                                <h3 class="gdlr-room-title"><a href="#"><?php echo $value['Type']?> Room </a></h3>
                                                <div class="gdlr-hotel-room-info">
                                                    <div class="gdlr-room-info"><i class="fa fa-check-square-o icon-check"></i><span class="gdlr-head">Bed</span><span class="gdlr-tail"><?php echo $value['Bed']?></span></div>
                                                    <div class="gdlr-room-info"><i class="fa fa-check-square-o icon-check"></i><span class="gdlr-head">Max People</span><span class="gdlr-tail"><?php echo $value['Accomodate']?></span></div>
                                                    <div class="gdlr-room-info"><i class="fa fa-check-square-o icon-check"></i><span class="gdlr-head">AC</span><span class="gdlr-tail"><?php 
                                                        if($value['AC']==1)
                                                            { echo "Yes";}
                                                        else{ echo "No"; }
                                                    ?></span></div>
                                                    <div class="gdlr-room-price"><span class="gdlr-head">Price</span><span class="gdlr-tail"><?php echo $value['Price']?> &#x20B9; / Night</span></div>
                                                    <div class="clear"></div>
                                                </div><a class="gdlr-button with-border" href="<?php echo base_url()?>home/checkavl">Check Details<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a></div>
                                        </div>
                                    </div>
                                    <?php
                                     }
